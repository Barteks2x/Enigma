...
public class McpHashEntryTree<T> implements EntryTree<T> {
    ...
    private final McpMappings deltas;

    public McpHashEntryTree(HashEntryTree<T> delegate, McpMappings mappings, JarTypeInfo jarInfo, McpConfig mcpConfig,
            McpMappings deltas) {
    ...
    public McpMappings getOriginalMcpMappings() {
    ...
    public McpMappings getMergedMcpMappings() {
        return originalMcpMappings.applyDeltas(deltas);
    }

    public McpMappings getOldDeltas() {
        return deltas;
    }
}
